...
function setWallpaper(hour) {
    if(hour>=17){
        if(body.style.backgroundImage != 'url("../images/evening.jpg")') {
            body.style.backgroundImage = 'url("../images/evening.jpg")';
            body.style.color="white";
        }
    }
    else if(hour>=12){
        if(body.style.backgroundImage != 'url("../images/afternoonjpg")') {
            body.style.backgroundImage = 'url("../images/afternoon.jpg")';
            body.style.color="black";
        }    
    }
    else{
        if(body.style.backgroundImage != 'url("../images/morning.jpg")') {
